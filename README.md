...
Профессиональная 3D печать в Омске. Статический сайт с интерактивным калькулятором, админ-панелью и интеграцией с Telegram.
...
2. **Настройте Telegram** (см. [TELEGRAM_SETUP_GUIDE.md](./TELEGRAM_SETUP_GUIDE.md))
...
- **[TELEGRAM_SETUP_GUIDE.md](./TELEGRAM_SETUP_GUIDE.md)** - 🔴 ВАЖНО! Настройка Telegram бота
- **[PRODUCTION_DEPLOYMENT_GUIDE.md](./PRODUCTION_DEPLOYMENT_GUIDE.md)** - Полный чеклист деплоя
...
│   ├── database.js         # localStorage обертка
...
- **JavaScript ES6** - логика (классы, async/await)
