 ...
 * Capsule manager with full Facade support. It reads configuration from .env
 * file (if available) or falls back to the legacy config.php constants.
 * 
 * Usage:
...
// Initialize Eloquent with proper Facade support
try {
